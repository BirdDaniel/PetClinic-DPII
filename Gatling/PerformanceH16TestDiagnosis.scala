...
class PerformanceH16TestDiagnosis extends Simulation {
	...
	setUp(reqCSnc.inject(rampUsers(20000) during (10 seconds)),
	      noReqCSnc.inject(rampUsers(20000) during (10 seconds)),
	      reqRSnc.inject(rampUsers(20000) during (10 seconds)),
	      noReqRSnc.inject(rampUsers(20000) during (10 seconds))
