...
public class EditAndUpdateItemNegativeUITest {
	...
	private int port;
		  ...
		  @Test
		  public void testEditAndUpdateNegativeUI() throws Exception {
		    ...
		    driver.findElement(By.id("price")).sendKeys("doscientos");
		    driver.findElement(By.xpath("//button[@type='submit']")).click();
		  }
